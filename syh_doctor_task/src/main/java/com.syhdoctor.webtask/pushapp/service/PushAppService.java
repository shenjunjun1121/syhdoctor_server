...
public class PushAppService extends BaseService {
    ...
    public void getAnswerOrderBySevenDays() {
        ...
        for (Map<String, Object> map : mapList) {
            ...
            pushAppMapper.addPushApp(TextFixed.messageServiceTitle,
                    ...
                    TypeNameAppPushEnum.inquiryOrderEnd.getCode(), String.valueOf(orderId),
            ...
            systemService.addMessage("", TextFixed.messageServiceTitle,
                    ...
                    TypeNameAppPushEnum.inquiryOrderEnd.getCode(), userId, TextFixed.answerUserSevenDays, "");//app 医生 内推送
    ...
    public void getDepartmentOrderBySevenDays() {
        ...
        for (Map<String, Object> map : mapList) {
            ...
            systemService.addMessage("", TextFixed.messageServiceTitle,
                    MessageTypeEnum.user.getCode(), String.valueOf(orderId),
                    TypeNameAppPushEnum.inquiryOrderEnd.getCode(), userId, TextFixed.phoneUserSevenDays, "");//app 医生 内推送
    ...
    public void getPhoneTenTime() {
        ...
        if (mapList.size() > 0) {
            for (Map<String, Object> map : mapList) {
                ...
                systemService.addMessage("", TextFixed.messageServiceTitle,
                        MessageTypeEnum.user.getCode(), String.valueOf(orderId),
                        TypeNameAppPushEnum.PhoneOrderTenTime.getCode(), (int) userid, TextFixed.phoneUserTenMinuteText, "");//app 用户 内推送

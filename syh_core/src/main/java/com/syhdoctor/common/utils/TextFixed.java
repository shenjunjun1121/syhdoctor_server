...
public class TextFixed {
    ...
    public static String userServerVoiceTitle = "%s用户给您发来一条语音";

    //图文图文聊天推送
    public static String doctorServerTextTitle = "%s医生给您发来一条消息";
    public static String userServerTextTitle = "%s用户给您发来一条消息";

    //图文图片聊天推送
    public static String doctorServerImageTitle = "%s医生给您发来一张图片";
    public static String userServerImageTitle = "%s用户给您发来一张图片";

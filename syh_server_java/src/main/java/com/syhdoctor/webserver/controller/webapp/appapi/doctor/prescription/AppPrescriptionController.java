...
public class AppPrescriptionController extends BaseController {
    ...
    @PostMapping("/addPrescriptionByOften")
    public Map<String, Object> addPrescriptionByOften(@ApiParam(hidden = true) @RequestParam Map<String, Object> params) {
        Map<String, Object> result = new HashMap<>();
        long oftenPrescriptionId = ModelUtil.getLong(params, "oftenprescriptionid");
        String presNo = ModelUtil.getStr(params, "presno");
        long orderId = ModelUtil.getLong(params, "orderid");
        result.put("data", prescriptionService.addPrescriptionByOften(oftenPrescriptionId,presNo,orderId));
        setOkResult(result, "查询成功");
        return result;
    }*/

...
//    }
    ...
    public boolean examineDoctor(long doctorId, int examine, long agentId, String reason, int doctype) {
        String sql = "update doctor_info set examine=?,reason=?,modify_time=?,modify_user=?,doc_type=? where doctorid=?";
        List<Object> params = new ArrayList<>();
        params.add(examine);
        params.add(reason);
        params.add(UnixUtil.getNowTimeStamp());
...
//        params.add(ycPresRecordFlag);
     ...
     * @return
     */
    public boolean insertDoctorClinic(long medclassid, String medclassname, BigDecimal price, long doctorid, int whetheropen) {
    ...
    public boolean addDoctorDutyRule(long doctorId, boolean monday, boolean tuesday, boolean wednesday, boolean thursday, boolean friday, boolean saturday, boolean sunday, String startTime, String endTime) {
     ...
     * @return
     */
    public boolean addDoctorPrice(int meadClassId, String meadClassName, BigDecimal price, long doctorId, long whetherOpen) {
     ...
     * @param visitingEndTime   排班结束时间
     */
    public boolean updateDoctorOnduty(int id, long doctorId, long visitingStartTime, long visitingEndTime, int shift) {
...
//        params.add(pracNo);
     ...
     * @return
     */
    public boolean updateTrialParty(int examine, int doctype, String docName, String docPhotoUrl, int titleId, long hospitailid,
                                    String dooTel, String idCard, String professional,
                                    String introduction, int gender, int departmentId, long doctorId) {
...
//        params.add(pracNo);
     ...
     * @return
     */
    public long addClinics(String docName, String docPhotoUrl, int titleId, long hospitalid, String dooTel, String idCard,
...
//        params.add(pracNo);
     ...
     * @return
     */
    public long addExpertPhysician(String docName, String docPhotoUrl, int titleId, long hospitalid, String dooTel, String idCard,
                                   String professional, String introduction, int gender, int departmentId) {
        long doctorId = getId("doctor_info");
        String inDocCode = UnixUtil.addZeroForNum(doctorId, 2);
        String sql = "insert into doctor_info (" +
...
//        params.add(pracNo);
     ...
     * @return
     */
    public long addTrialPartys(int doctype, String docName, String docPhotoUrl, int titleId, long hospitalid, String dooTel, String idCard,
                               String professional, String introduction, int gender, int departmentId) {
        long doctorId = getId("doctor_info");
        String inDocCode = UnixUtil.addZeroForNum(doctorId, 2);
        String sql = "insert into doctor_info (" +
...
//                map.put("doctype", DoctorTypeEnum.getValue(ModelUtil.getInt(map, "doctype")).getMessage());
     ...
     * @return
     */
    public long addAdviser(String docName, String docPhotoUrl, int titleId, long hospitalid, String dooTel, String idCard,
                           String professional, String introduction, int gender, int departmentId) {
        long doctorId = getId("doctor_info");
        String inDocCode = UnixUtil.addZeroForNum(doctorId, 2);
        String sql = "insert into doctor_info (" +
...
//                map.put("doctype", DoctorTypeEnum.getValue(ModelUtil.getInt(map, "doctype")).getMessage());
     ...
     * @return
     */
    public long addTrialParty(String docName, String docPhoto, String docPhoneUrl, int docType, int titleId, String workInstCode,
                              String workInstName, long hospitalid, String dooTel, String idCard, String pracNo, long pracRecDate, String certNo, long certRecDate, String titleNo,
                              long titleRecDate, String pracType, String qualifyOrNot, String professional,
                              long signTime, String signLife, String employFile, String employFileUrl, String creditLevel, String occuLevel,
                              String digitalSign, String digitalSignUrl, String docPenaltyPoints, String pracScope, String pracScopeApproval, int agreeTerms,

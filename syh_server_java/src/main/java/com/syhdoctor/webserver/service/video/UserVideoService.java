...
//        }
    ...
    public void addVideoOrderPushData(String orderNo) {
        ...
        systemService.addMessage("", TextFixed.messageOrderTitle,
                ...
                TypeNameAppPushEnum.VideoOrderDetail.getCode(), userId, String.format(TextFixed.videoUserOrderPushTitleText, UnixUtil.getDate(createTime, "yyyy-MM-dd HH:mm:ss")), "");//app 用户内推送
        //用户端消息结束
        ...
        systemService.addMessage("", TextFixed.messageOrderTitle,
                ...
                TypeNameAppPushEnum.VideoOrderDetail.getCode(), doctorId, String.format(TextFixed.videoDoctorOrderText, name, UnixUtil.getDate(subscribetime, "yyyy-MM-dd HH:mm")), "");//app 医生 内推送
        //医生端消息结束
    }
